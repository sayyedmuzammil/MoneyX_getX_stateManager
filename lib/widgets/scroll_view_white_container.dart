...
Stack scrollView_container(BuildContext context) {
 ...
 Future pickDateRange(BuildContext context) async {
   ...
   main_widget_controller.dateRange = newDateRange;
    ...
    var _selectedFirst = DateFormat('MMM dd').format(main_widget_controller.dateRange!.start);
    var _selectedEnd = DateFormat('MMM dd').format(main_widget_controller.dateRange!.end);
    // print(dateRange);
    if (main_widget_controller.dateRange != null) {
      main_widget_controller.getAllitemWidget();
      // dataControl.cardList == 1
      //     ? getPieChartValue(1)
      //     : dataControl.cardList == 2
      //         ? getPieChartValue(2)
      //         : dataControl.cardList == 3
      //             ? getPieChartValue(3)
      //             : getPieChartValue(4);
      /*  setState(() { */
