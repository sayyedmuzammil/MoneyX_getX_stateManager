...
class list_widget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print("building list view widget");
    ...
    return FutureBuilder<List<Map<String, Object?>>> (
        ...
        builder: (context, listItem) {
             if(  listItem.connectionState==ConnectionState.waiting ) {return const  CircularProgressIndicator(); }
          int pointer = -1;
          int counter = -1;
          dateSets = [];

          if (listItem.data == null || listItem.data!.isEmpty || dataControl.dataMap.isEmpty && percentIndicator==true ) {
            // print("777 this is working");
            return Tooltip(
              message: "Alert!",
              child: InkWell(
                onTap: () {},
                                  ...
                                  : Column(
                                      children: [
                                        for (var i in AllRows)
                                          ...
                                          InkWell(
                                            onTap: () {
                                              bottomSheet_edit(context, i,toggleisUpdateClicked);
                                            },
                                            child: Row(
                                              mainAxisAlignment:
                                                  MainAxisAlignment
